...
// Update the displaySchoolDetails function in script.js to include motto and image display:
...
function displaySchoolDetails(schoolId) {
    ...
    // Create motto HTML if motto exists
    let mottoHTML = '';
    if (school.schoolMotto || school.chineseMotto) {
        mottoHTML = `
            <div class="school-detail-item">
